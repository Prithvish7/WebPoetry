...
# Hosts: local + Render hostname later
...
# If DATABASE_URL is set (e.g. on Render), use PostgreSQL instead
DATABASE_URL = os.getenv('DATABASE_URL')
if DATABASE_URL:
    DATABASES['default'] = dj_database_url.parse(
        DATABASE_URL,
        conn_max_age=600,   # keep DB connections open (good for performance)
